...
def get_BSSI(ssid):
    ...
    try:
        ...
        try:
            ...
            for network in networks2:
                ...
                rr = str(network.ulIeSize)
                # print(SSID)
                # if str(SSID) == '5G':
                #     print( "SSID: " + SSID + " BSSID: "+ BSSID+ " SS: "+signal_strength+' rate '+rr)
                # print(SSID,signal_strength)
                BSSI_Values[SSID] = [SSID,signal_strength]
                RSSI = BSSI_Values[SSID][-1]
                # print(RSSI)
    ...
    # print(BSSI_Values[ssid])
    print(ssid,' RSSI:',BSSI_Values[ssid][1],'dBm')
    return BSSI_Values[ssid][1]
